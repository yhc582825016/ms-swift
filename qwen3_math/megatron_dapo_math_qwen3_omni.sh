...
export SWANLAB_EXPERIMENT_NAME="${SWANLAB_EXPERIMENT_NAME:-Qwen3-Omni-30B-A3B-Instruct-309-dapo-math}"
...
LOG_PATH="${MS_SWIFT_ROOT}/logs/Qwen3-Omni-30B-A3B-Instruct-309-dapo-math-lora.log"
...
megatron rlhf \
    ...
    --output_dir "${MS_SWIFT_ROOT}/megatron_output/Qwen3-Omni-30B-A3B-Instruct-309-dapo-math"
    # > "/mnt/code/yehangcheng/ms-swift/megatron_output/logs/Qwen3-Omni-30B-A3B-Instruct-307-gspo-math-lora.log" 2>&1 &
