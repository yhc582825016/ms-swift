...
export SWANLAB_EXPERIMENT_NAME="${SWANLAB_EXPERIMENT_NAME:-Qwen3-Omni-30B-A3B-Instruct-gspo-if-306-lora-cispo}"
...
nohup megatron rlhf \
    ...
    --output_dir "${MS_SWIFT_ROOT}/megatron_output/Qwen3-Omni-30B-A3B-Instruct-gspo-if-306-lora-cispo" \
    > "/mnt/code/yehangcheng/ms-swift/megatron_output/logs/Qwen3-Omni-30B-A3B-Instruct-gspo-if-306-lora-cispo.log" 2>&1 &