...
export SWANLAB_EXPERIMENT_NAME="${SWANLAB_EXPERIMENT_NAME:-Qwen3-Omni-30B-A3B-Instruct-309-reinforce_plus_plus-math}"
...
LOG_PATH="${MS_SWIFT_ROOT}/logs/Qwen3-Omni-30B-A3B-Instruct-309-reinforce_plus_plus-math.log"
...
megatron rlhf \
    ...
    --output_dir "${MS_SWIFT_ROOT}/megatron_output/Qwen3-Omni-30B-A3B-Instruct-309-reinforce_plus_plus-math"