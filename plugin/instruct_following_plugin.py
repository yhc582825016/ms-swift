...
class InstructFollowingStrictORM(ORM):
    """
    Strict instruct-following reward migrated from verl/recipe/insturct_following/reward_function.py.
    Reward policy:
...
orms['external_if_strict'] = InstructFollowingStrictORM
